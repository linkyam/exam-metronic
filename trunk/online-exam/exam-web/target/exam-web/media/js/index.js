    ...
    com.ajax.jsonGet("/user/getAllMenu","",function(result){
        if (result && result.data) {
            ...
            $.each(result.data, function (i, obj) {
                titleHtml +="<li><a class='active' href='javascript:;'><i class='icon-sitemap'></i><span class='title'>" + obj.naName + "</span>"
                if(obj.menus && obj.menus.length > 0){
                    var t="";
                    t=getChildMemu(t,obj.menus);
                    titleHtml+= "<span class='arrow'></span></a>"+t+"</li>";
                }else{
                    titleHtml +="</a></li>";
                }
            });
...
function getChildMemu(t,menu){
    ...
    $.each(menu, function (i, m) {
        if(m.childMenu&&m.childMenu.length>0){
            ...
            t+="<li><a href='javascript:;' value='" + m.menuUrl + "'>"+ m.menuName+"<span class='arrow'></span></a>"+k+"</li>";
        }else{
            t+="<li><a href='#' value='" + m.menuUrl + "'>"+ m.menuName+"</a></li>";
        }
    });
    t+="</ul>";
    return t;
